package ru.nilsolk.gymapp.ui.calculators.body_fat_calculator
...
import ru.nilsolk.gymapp.databinding.FragmentBodyFatPercentageBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        with(bodyFatPercentageBinding)
        {
            goBackImage.setOnClickListener {
                val goBackAction =
                    BodyFatPercentageFragmentDirections.actionBodyFatPercentageFragmentToCalculatorFragment()
