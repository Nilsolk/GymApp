package ru.nilsolk.gymapp.ui.calculators.one_rm
...
import ru.nilsolk.gymapp.databinding.FragmentOneRmBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        with(fragmentOneRmFragmentBinding) {
            ...
            goBackImage.setOnClickListener {
                val goBackAction =
                    OneRmFragmentDirections.actionOneRmFragmentToCalculatorFragment()
